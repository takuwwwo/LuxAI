...
policy_net.load_state_dict(torch.load(f'{path}/model/23281649_7_layer18.pth'))
policy_net.eval()
agent_ = Agent(policy_net, research_th=0.05, research_turn=15)
